...
public class MessageQueue_my {
    private static final String TAG = MessageQueue_my.class.getName();
    Message_my[] mItems;
    int mPutIndex;
    //队列中消息数
    private int mCount;
    ...
    public MessageQueue_my() {
        mItems = new Message_my[50];
    ...
    public void enqueueMessage(Message_my message) {
